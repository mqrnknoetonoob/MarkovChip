module Result_Shift_Memory (
    ...
    //output wire [3:0] active_write_index       // Debug port to monitor current 0-15 counter index (Commented out)
);
    ...
    // assign active_write_index = write_counter; // Commented out to match the port
