...
write_verilog -noattr ../Synthesized_Files/Netlist_Files/Markov_Chain_Accelerator_Netlist_Flat.v

# 8. Generate and save area/cell statistics report
tee -o ../Synthesized_Files/Yosys_Output_Log/flattened_stat_report.txt stat -liberty ../gf180mcu_fd_sc_mcu7t5v0__tt_025C_1v80.lib